  ...
  <section>
    ...
    <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
      <el-form :inline="true" :model="filters">
        <el-form-item>
          <el-input v-model="filters.name" placeholder="编号" @input="getCircle"></el-input>
        </el-form-item>
        <el-form-item>
          <el-button type="primary" v-on:click="getCircle">查询</el-button>
        </el-form-item>
        <el-form-item>
    ...
    <!--列表-->
    <el-table :data="circle" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
...
import {getCircleList, removeCircle, editCircle, addCircle} from '../../api/api';
