  ...
  <section>
    ...
    <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
      <el-form :inline="true" :model="filters">
        <el-form-item>
          <el-input v-model="filters.name" placeholder="编号" @input="getAddress"></el-input>
        </el-form-item>
        <el-form-item>
          <el-button type="primary" v-on:click="getAddress">查询</el-button>
        </el-form-item>
        <el-form-item>
    ...
    <el-table :data="address" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
      ...
      <el-table-column prop="name" label="地址" width="140"  sortable>
      </el-table-column>
...
import {getAddressList, removeAddress, editAddress, addAddress} from '../../api/api';
