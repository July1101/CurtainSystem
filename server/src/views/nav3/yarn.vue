  ...
  <section>
    ...
    <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
      <el-form :inline="true" :model="filters">
        <el-form-item>
          <el-input v-model="filters.name" placeholder="编号" @input="getYarn"></el-input>
        </el-form-item>
        <el-form-item>
          <el-button type="primary" v-on:click="getYarn">查询</el-button>
        </el-form-item>
        <el-form-item>
    ...
    <!--列表-->
    <el-table :data="yarn" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
      ...
      <el-table-column prop="version_id" label="编号" width="140"  sortable>
      </el-table-column>
    ...
    <el-dialog title="编辑" :visible="editFormVisible" @close="editFormVisible=false" :close-on-click-modal="false">
      <el-form :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
        ...
        <el-form-item label="编号" prop="version_id">
          <el-input v-model="editForm.version_id"></el-input>
        </el-form-item>
...
import {getYarnList, removeYarn, editYarn, addYarn} from '../../api/api';
